export const ThreeDAnimationData = {
  ...
  Costof: {
    ...
    heading2: "The Cost of Weak Visuals",
  },
  ProfessionalLogoDesign: {
    heading: "What Happens With 3D Animation",
    items: [
      {
        text: "Hyper-realistic renders <strong>captivate</strong> instantly and draw audience attention.",
      },
      {
        text: "Complex ideas are <strong>simplified</strong>, making them easier to understand.",
      },
      {
        text: "Campaigns feel <strong>premium</strong>, polished, and ready for the future.",
      },
      {
        text: "Sales cycles <strong>shorten</strong> as visuals accelerate decision-making.",
      },
    ],
    video: "/assets/videos/services/creative/3D-Animation-&-Rendering.mp4",
  },
  BrandStrategy: {
    heading: "What You Get",
    items: [
      {
        text: "Photo-real product <strong>visualizations</strong> that showcase your products in detail.",
      },
      {
        text: "Cinematic animated <strong>explainer</strong> and demo videos to engage and inform.",
      },
      {
        text: "Interactive 3D <strong>assets</strong> to provide a dynamic, hands-on experience.",
      },
      {
        text: "Platform-ready <strong>exports</strong> and usage guidance for seamless integration.",
      },
  ...
  FAQ: {
    ...
    items: [
      {
        question: "1. What industries benefit from 3D animation?",
        answer:
          "E-commerce, real estate, product design, architecture, and entertainment all see strong results from 3D visuals.",
      },
      {
        question: "2. Do you handle both animation and still rendering?",
        answer:
          "Yes, we create motion graphics, animated videos, and hyper-realistic renders.",
      },
      {
        question: "3. How long does a 3D project take?",
        answer:
          "Timelines depend on complexity. Simple renders can take 1–2 weeks; full animations may take 4–6 weeks.",
      },
      {
        question: "4. Can you animate my existing 3D models?",
        answer:
          "Yes, we can work with your models or create new ones from scratch.",
      },
      {
        question: "5. Do I need 3D animation if I already have photography?",
        answer:
          "Yes, 3D offers angles, clarity, and flexibility photography can’t provide, especially for complex products.",
      },
      {
        question: "6. What formats will I receive?",
        answer:
          "We deliver video files (MP4, MOV) and image renders (PNG, JPEG), plus source files if needed.",
      },
    ],
  }
