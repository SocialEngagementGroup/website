export const logoDesignData = {
  ...
  intro: {
   ...
   bg: "/assets/services/cta/Digital-google-business-profile.png",
    ...
    items: [
  {
   img: "/assets/services/creative/logo-design/logo-design.png",
    text: "You get <strong>forgotten</strong> within seconds due to poor logo design.",
  },
  {
   img: "/assets/services/creative/logo-design/Differentiation-in-the-market.png",
    text: "Your <strong>logo looks</strong> generic and lacks differentiation in the market.",
  },
  {
   img: "/assets/services/creative/logo-design/Referrals-fall-flat.png",
    text: "<strong>Referrals</strong> fall flat because people can’t describe or recall your logo.",
  },
  {
   img: "/assets/services/creative/logo-design/You-appear-amateur.png",
...
heading2: "The Cost of Weak Branding",
  ...
  video: "/assets/videos/services/creative/Logo.mp4",
   ...
   img: "/assets/services/creative/logo-design/creative-logo-design.png",
  },
  FAQ: {
    heading: "FAQs",
    items: [
      {
        question: "1. Do I need a professional logo if I already have one?",
        answer:
          "Yes. Many brands start with a basic mark, but a professional redesign improves credibility, consistency, and memorability across all touchpoints.",
      },
      {
        question: "2. How much does logo design cost?",
        answer:
          "It depends on scope. Packages typically include research, strategy, multiple concepts, revisions, and a complete logo suite with usage guidelines. Request a custom estimate.",
      },
      {
        question: "3. How long does the logo design process take?",
        answer:
          "Most projects take 2–4 weeks, covering discovery, concept development, revisions, and final delivery.",
      },
      {
        question: "4. Will I own the rights to my logo?",
        answer:
          "Yes. Upon completion and final payment, you receive full ownership and usage rights.",
      },
      {
        question: "5. What files will I receive?",
        answer:
          "All essential formats: high-resolution PNGs/JPEGs, scalable vectors (AI, EPS, SVG), and web-ready versions plus a usage guide.",
      },
      {
        question: "6. How many revisions are included?",
        answer:
          "Unlimited revisions until we finalize a direction you love and it meets your brand standards.",
      },
    ],
  },
