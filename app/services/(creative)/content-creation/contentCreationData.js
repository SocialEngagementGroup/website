export const contentCreationData = {
  ...
  Costof: {
    ...
    items: [
      {
       img: "/assets/images/services/icons/creative/creative-content/audience-engagement.webp",
        text: "Your posts and ads get lost in crowded social media feeds, leading to low <strong>audience engagement.</strong>",
      },
      {
       img: "/assets/images/services/icons/creative/creative-content/memorable-impact.webp",
        text: "Your campaigns feel <strong>generic</strong> and fail to make a memorable impact.",
      },
      {
       img: "/assets/images/services/icons/creative/creative-content/you-struggle-to-build-a-loyal-community.webp",
        text: "Your <strong>brand message</strong> gets diluted, and you struggle to build a loyal community.",
      },
      {
       img: "/assets/images/services/icons/creative/creative-content/win-the-online-conversation-and-market-share.webp",
