export const SocialMediaContentData = {
  ...
  Costof: {
    ...
    items: [
      {
       img: "/assets/services/creative/social-media-content/Low-engagement.png",
        text: "<strong>Low engagement</strong> and limited reach hinder social media growth.",
      },
      {
       img: "/assets/services/creative/social-media-content/Missed-trends-and-timing.png",
        text: "<strong>Missed trends</strong> and timing windows reduce content relevance.",
      },
      {
       img: "/assets/services/creative/social-media-content/lower-follower-growth.png",
        text: "<strong>Slower follower</strong> growth and weaker community impact brand loyalty.",
      },
      {
       img: "/assets/services/creative/social-media-content/Inconsistent-presence.png",
...
},
{
  text: "You lead the conversation in your niche, becoming an industry <strong>authority</strong>.",
    ...
    video: "/assets/videos/services/creative/Social-Media-Content.mp4",
  },
  BrandStrategy: {
...
},
{
  text: "<strong>Engagement</strong> tracking and optimization to boost performance and results.",
   ...
   img: "/assets/services/creative/social-media-content/creative-social-media-content.png",
  },
  FAQ: {
    heading: "FAQs",
    items: [
      {
        question: "1. What platforms do you create social content for?",
        answer:
          "We specialize in Meta (Facebook & Instagram), TikTok, LinkedIn, and emerging platforms.",
      },
      {
        question: "2. Do you manage posting as well as content creation?",
        answer:
          "Yes, we can create, schedule, and manage engagement so your brand stays active and consistent.",
      },
      {
        question: "3. How do you decide what kind of content works best?",
        answer:
          "We use trend analysis, audience insights, and competitor research to design posts that resonate and convert.",
      },
      {
        question: "4. Can you repurpose my existing content?",
        answer:
          "Yes, we adapt and redesign your current assets for different platforms to maximize reach.",
      },
      {
        question: "5. What’s the difference between organic and paid social content?",
        answer:
          "Organic builds community, while paid amplifies reach. We create strategies for both to maximize ROI.",
      },
      {
        question: "6. How quickly can I see results from social media content?",
        answer:
          "Engagement can increase within weeks, while follower growth and conversions build over a few months.",
      },
    ],
  },
};
