export const SocialMediaContentData = {
  ...
  intro: {
   ...
   trustBar: {
    ...
    description:
      "We've helped brands across various industries craft scroll-stopping content that resonates and converts. Join our list of satisfied clients and take your social media strategy to the next level.",
  },
  Costof: {
    ...
    items: [
      ...
      {
       img: "/assets/images/services/creative/social-media-content/lower-follower-growth.png",
...
},
{
  text: "You lead the conversation in your niche, becoming an industry <strong>authority</strong>.",
    ...
    video: "/assets/videos/services/creative/social-media-content.webm",
  },
  BrandStrategy: {
