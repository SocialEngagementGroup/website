export const GoogleBusinessData = {
  ...
  Costof: {
    ...
    heading2: "The Cost of Ignoring Google Business",
    description:
    ...
    items: [
     {
   img: "/assets/images/services/digital/google-business-profile-management/Missed-calls.png",
    text: "<strong>Missed calls</strong>, visits, and customer inquiries that should have come to you.",
  },
  {
   img: "/assets/images/services/digital/google-business-profile-management/Local-visibility-drops.png",
    text: "Local <strong>visibility drops</strong> as competitors appear more often in search results.",
  },
  {
   img: "/assets/images/services/digital/google-business-profile-management/Your-reputation-weakens.png",
    text: "<strong>Your reputation</strong> weakens with unbalanced or unmanaged public reviews.",
  }, 
  {
   img: "/assets/images/services/digital/google-business-profile-management/Outdated-or-inconsistent-listing-details-hurt-credibility.png",
  ...
  ProfessionalSEO: {
    ...
    video: "/assets/videos/services/digital/Google-Business-Profile-Management.webm",
  },
  ...
  BrandStrategy: {
   ...
   img: "/assets/images/services/digital/google-business-profile-management/digital-google-business-profile-management.png",
  },
  ...
  FAQ: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes, we handle profiles for franchises and multi-location businesses.",
      },
      {
        question: "3. How often do you update my profile?",
        answer:
          "We post updates, offers, and photos regularly to keep your profile active.",
      },
      {
        question: "4. Do you respond to customer reviews?",
        answer:
          "Yes, we help manage review responses to protect and grow your reputation.",
      },
      {
        question: "5. How do you track profile performance?",
        answer:
          "We provide insights on views, clicks, calls, and direction requests.",
      },
      {
        question: "6. Will optimization improve my local SEO?",
        answer:
          "Yes, Google Business Profile is a major ranking factor for local search.",
      },
    ],
  },
};
