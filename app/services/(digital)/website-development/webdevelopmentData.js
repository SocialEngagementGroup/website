export const webdevelopmentData = {
  ...
  ProfessionalSEO: {
    ...
    video: "/assets/videos/services/digital/Website-Development.mp4",
  },

  BrandStrategy: {
    heading: "What You Get",
    items: [
      { text: "Custom website design and development tailored to your brand." },
      {
        text: "Smooth CMS integration across WordPress, Next.js, Shopify, and more.",
      },
      {
        text: "Complete SEO and analytics setup for visibility and performance.",
      },
      {
