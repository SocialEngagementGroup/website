export const ReviewReputationData = {
  ...
  intro: {
    heading: "Turn Public Feedback Into a Competitive Advantage",
    description:
  ...
  Costof: {
    ...
    heading2: "The Cost of Poor Reputation Management",
    description:
    ...
    items: [
      {
       img: "/assets/services/digital/review-and-reputation-management/bad-reviews.png",
        text: "<strong>Bad reviews</strong> sit unanswered, damaging credibility and first impressions.",
      },
      {
       img: "/assets/services/digital/review-and-reputation-management/prospects-turn-to-competitors.png",
        text: "Prospects turn to <strong>competitors</strong> with stronger ratings and responses.",
      },
      {
       img: "/assets/services/digital/review-and-reputation-management/trust-fades-quickly-when-feedback-isn’t-managed.png",
        text: "<strong>Trust fades</strong> quickly when feedback isn’t managed or acknowledged.",
      },
      {
       img: "/assets/services/digital/review-and-reputation-management/search-visibility-drops.png",
  ...
  ProfessionalSEO: {
    heading: "What Happens With Proactive Management",
    items: [
      { text: "Positive reviews increase steadily as satisfied customers share feedback." },
      { text: "Negative comments are addressed quickly to protect credibility and trust." },
  ...
  BrandStrategy: {
   ...
   img: "/assets/services/digital/review-and-reputation-management/digital-review-and-reputation-management.png",
  },
  ...
  FAQ: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "We can’t remove them, but we can manage responses and push down harmful content.",
      },
      {
