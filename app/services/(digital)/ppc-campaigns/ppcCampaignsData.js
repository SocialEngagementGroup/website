export const ppcCampaignsData = {
  ...
  ProfessionalSEO: {
    ...
    items: [
      { text: "Your ads reliably reach high-intent audiences ready to take action." },
      { text: "Every advertising dollar becomes more efficient and data-driven." },
  ...
  BrandStrategy: {
    ...
    items: [
      { text: "Complete full-funnel Google and Bing campaign architecture tailored for scale." },
      { text: "High-performance ad copy and creatives built to convert across channels." },
    ...
    items: [
      {
        ...
        answer:
          "We manage Google Ads, Bing Ads, YouTube, and social platforms like Meta and LinkedIn.",
      },
      {
        question: "2. How do you optimize PPC campaigns?",
        answer:
          "We track conversions, adjust targeting, test ad copy, and optimize bidding strategies.",
      },
      {
        question: "3. What budget do I need for PPC?",
        answer:
          "Budgets vary, but we’ll recommend the right spend based on your goals and industry competitiveness.",
      },
      {
        question: "4. Can you fix underperforming PPC campaigns?",
        answer:
          "Yes, we specialize in turning wasted ad spend into profitable results.",
      },
      {
        question: "5. Do you provide PPC reports?",
        answer:
          "Yes, clients receive performance dashboards and regular campaign reports.",
      },
      {
        question: "6. How soon can I see results from PPC?",
        answer:
          "Results can start within days, with ongoing optimization improving ROI over time.",
      },
    ],
  },
};
