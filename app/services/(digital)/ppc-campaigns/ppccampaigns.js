export const PpcServiceData = {
  ...
  intro: {
    heading: "Turn Ad Spend Into Scaled Results",
    description:
...
},
{
  ...
  ProfessionalSEO: {
    heading: "What Happens With Strategic PPC",
    items: [
      { text: "Your ads consistently reach high-intent audiences ready to convert." },
      { text: "Every dollar becomes more efficient and data-driven." },
      { text: "Conversions increase steadily across all campaigns." },
      { text: "CPA drops naturally while ROAS improves and scales." },
    ],
  ...
  BrandStrategy: {
    ...
    items: [
      { text: "Full-funnel campaign architecture across Google and Bing." },
      { text: "High-performance ad copy and creatives built to convert." },
    ...
    items: [
      {
        ...
        answer:
          "We manage Google Ads, Bing Ads, YouTube, Meta Ads, and LinkedIn campaigns.",
      },
      {
        question: "2. How do you optimize PPC campaigns?",
        answer:
          "We refine targeting, track conversions, A/B test ads, and optimize bidding strategies.",
      },
      {
        question: "3. What budget do I need for PPC?",
        answer:
          "Budgets vary by industry, but we recommend the optimal spend based on your goals and competition.",
      },
      {
        question: "4. Can you fix underperforming PPC campaigns?",
        answer:
          "Yes, we specialize in turning wasted ad spend into profitable growth.",
      },
      {
        question: "5. Do you provide PPC reports?",
        answer:
          "Yes, clients receive dashboards and regular campaign performance reports.",
      },
      {
        question: "6. How soon can I see results?",
        answer:
          "Initial results can appear within days, with ongoing optimization improving ROI over time.",
      },
    ],
  },
};
