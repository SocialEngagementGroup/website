        ...
        <div className="w-[90%] mx-auto">
          <section className="py-6 mt-0 mb-8">
            <div className="mb-4 md:mb-6">
              ...
              <h3 className="text-white !text-[32px] md:!text-[40px] lg:!text-[48px] font-serif capitalize leading-tight">Visual Storytelling & Brand Identity</h3>
            </div>
          ...
          <section className="py-6 mt-4 md:mt-12 mb-8">
            <div className="mb-4 md:mb-6">
              ...
              <h3 className="text-white !text-[32px] md:!text-[40px] lg:!text-[48px] font-serif capitalize leading-tight">Next-Gen Digital Marketing</h3>
            </div>
          ...
          <section className="py-6 mt-4 md:mt-12 mb-8">
            <div className="mb-4 md:mb-6">
              ...
              <h3 className="text-white !text-[32px] md:!text-[40px] lg:!text-[48px] font-serif capitalize leading-tight">Tailored Industry Solutions</h3>
            </div>
          ...
          <section className="py-6 mt-4 md:mt-12 mb-12">
            <div className="mb-4 md:mb-6">
              ...
              <h3 className="text-white !text-[32px] md:!text-[40px] lg:!text-[48px] font-serif capitalize leading-tight">Data-Driven Growth Strategies</h3>
            </div>
