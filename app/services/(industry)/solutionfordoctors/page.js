...
import { solutionforDoctorsData } from "@/app/services/(industry)/solutionfordoctors/solutionforDoctorsData";
...
export default function Page() {
  return (
    <>
      ...
      <BrandingStrategy {...solutionforDoctorsData.BrandStrategy} />
