...
export default function ConverterPage() {
  return (
    ...
    <main className="bg-black min-h-screen pt-20 md:pt-32 pb-16 md:pb-24 font-sans text-white relative overflow-hidden">
      ...
      <div className="container-fluid w-[90%] md:w-[85%] mx-auto relative">
         <ConverterPlatform />
      </div>
    </main>
  );
