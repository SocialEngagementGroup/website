...
const PlaceHolder = ({ bg, title, button, link }) => {
  return (
    ...
    >
      <div
        className={`${styles.bgglass} w-full flex flex-col md:flex-row items-center justify-between  p-10 md:p-20`}
      >
        ...
        <a href={link}>
          <button className={`${styles.button} py-2 md:py-2 px-5 md:px-8 md:mt-0 mt-5`}>
            {button}
          </button>
        </a>
      </div>
