      ...
      >
        <div className="text-center">
          ...
          <div className="text-white content">
            <h1 className="max-w-[1000px] mx-auto pb-4 text-3xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight">
              Where Human Creativity Meets <br className="hidden md:block" />{" "}
              AI-Powered Growth
            </h1>
            <p className="max-w-[665px] mx-auto mt-2 md:mt-4 text-sm md:text-base lg:text-lg opacity-90 p1 md:pt-4 px-2 md:px-5">
              We tell your story across every digital touchpoint —{" "}
              <br className="hidden md:block" /> blending creativity and
              automation so your business grows{" "}
              <br className="hidden md:block" /> & converts
            </p>
          </div>
